export class PerfilFsRequestModel {
    ...
    constructor(id?: string | number, fs_rut?: number, fs_dv?: string, fecha_calculo?: string, vel_maxima?: number,
                vel_1rtos_200_t1?: number, vel_tren_carr_t1?: number, vel_pos_fs_t1?: number,
                vel_ult_200_t1?: number, vel_final_t1?: number, perfil_fs_t1?: string, perfil_fs_t2?: string) {
